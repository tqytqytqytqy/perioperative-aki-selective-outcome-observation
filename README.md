...
- Version-specific DOI: assigned only after successful Zenodo publication; do not cite a draft identifier.
...
- Supersession: v3.2.5 supersedes v3.2.4 for current use and citation. Version v3.2.4 remains GitHub provenance only and has no published Zenodo version DOI; v3.2.0-v3.2.3 remain immutable provenance.
