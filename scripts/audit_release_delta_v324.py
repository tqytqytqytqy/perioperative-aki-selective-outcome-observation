#!/usr/bin/env python3
"""Prove that v3.2.4 changes only release and author metadata assets."""
...
OUTPUT_RELATIVE = "qa/v324_delta_from_v323.json"
ALLOWED_CHANGED = {
    ".zenodo.json",
    "CITATION.cff",
    "LICENSE-CODE",
...
def main() -> int:
    ...
    output = {
        ...
        "baseline": "v3.2.3 Git tag archive",
        "current": ".",
        ...
        "interpretation": (
            "Version v3.2.4 changes release, creator, and citation metadata only; "
            "aggregate scientific tables, model specification, figures, reports, "
            "configuration, and reference metadata are byte-identical to v3.2.3."
        ),
    }
